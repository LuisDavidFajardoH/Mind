...
const Diseno = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Nuestros procesos nos permiten asegurar que su producto cumple con las especificaciones de diseño e ingeniería. Adicionalmente damos respaldo y garantía a su empresa de los productos que desarrollemos para usted.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Descubre nuestra propuesta de valor en diseño metalmecánico. Ofrecemos servicios de escucha activa, diseño innovador, ingeniería avanzada y calidad garantizada para tus proyectos."
        />
        <meta
          name="keywords"
          content="Mind SAS BIC, diseño metalmecánico, innovación, escucha activa, ingeniería, calidad, transformación del metal, tecnología de simulación, productos de metal, fabricación de metal"
        />
      </Helmet>
      ...
      <div className="design-section">
        ...
        >
          En nuestra empresa de metalmecánica, nos destacamos por ofrecer un
          servicio integral que abarca desde la escucha activa de tus
          necesidades hasta la entrega de productos de la más alta calidad.
          Nuestro equipo de expertos está comprometido con la innovación y la
        ...
        <div className="additional-info" data-aos="fade-up">
          ...
          <Typography variant="body1" className="additional-description">
            Con años de experiencia en la industria de la metalmecánica, nos
            enorgullece ofrecer servicios de diseño, ingeniería y fabricación
            que superan las expectativas de nuestros clientes. Nuestro enfoque
            en la calidad y la innovación nos permite ofrecer soluciones
